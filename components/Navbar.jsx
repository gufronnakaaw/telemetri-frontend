          ...
          <Menu placement="bottom-end" allowHover>
            <MenuHandler>
              <div className="inline-flex cursor-pointer items-center gap-1.5">
                <Typography className="font-semibold capitalize text-gray-900 font-inter">
            ...
            <MenuList>
              <MenuItem>
                <Typography className="font-semibold text-gray-900 font-inter">
                  {status == 'loading' ? 'loading...' : data.user.fullname}
                </Typography>
                <Typography className="text-sm font-medium text-gray-500 font-inter">
              ...
              >
                ...
                <Typography className="text-sm font-medium font-inter">
                  Sign Out
                </Typography>
              </MenuItem>
            </MenuList>
